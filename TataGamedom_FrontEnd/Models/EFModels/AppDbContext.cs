...
namespace TataGamedom_FrontEnd.Models.EFModels
{
    public partial class AppDbContext : DbContext
    {
        ...
        public virtual DbSet<ApprovalStatusCode> ApprovalStatusCodes { get; set; } = null!;
        public virtual DbSet<BackendMember> BackendMembers { get; set; } = null!;
        public virtual DbSet<BackendMembersPermissionsCode> BackendMembersPermissionsCodes { get; set; } = null!;
        public virtual DbSet<BackendMembersRolePermission> BackendMembersRolePermissions { get; set; } = null!;
        public virtual DbSet<BackendMembersRolesCode> BackendMembersRolesCodes { get; set; } = null!;
        public virtual DbSet<Board> Boards { get; set; } = null!;
        public virtual DbSet<BoardsModerator> BoardsModerators { get; set; } = null!;
        public virtual DbSet<BoardsModeratorsApplication> BoardsModeratorsApplications { get; set; } = null!;
        public virtual DbSet<BucketLog> BucketLogs { get; set; } = null!;
        public virtual DbSet<Cart> Carts { get; set; } = null!;
        public virtual DbSet<Counter> Counters { get; set; } = null!;
        public virtual DbSet<Coupon> Coupons { get; set; } = null!;
        public virtual DbSet<CouponsProduct> CouponsProducts { get; set; } = null!;
        public virtual DbSet<DiscountTypeCode> DiscountTypeCodes { get; set; } = null!;
        public virtual DbSet<Faq> Faqs { get; set; } = null!;
        public virtual DbSet<Game> Games { get; set; } = null!;
        public virtual DbSet<GameClassificationGame> GameClassificationGames { get; set; } = null!;
        public virtual DbSet<GameClassificationsCode> GameClassificationsCodes { get; set; } = null!;
        public virtual DbSet<GameComment> GameComments { get; set; } = null!;
        public virtual DbSet<GamePlatformsCode> GamePlatformsCodes { get; set; } = null!;
        public virtual DbSet<Hash> Hashes { get; set; } = null!;
        public virtual DbSet<InventoryItem> InventoryItems { get; set; } = null!;
        public virtual DbSet<Issue> Issues { get; set; } = null!;
        public virtual DbSet<IssueStatusCode> IssueStatusCodes { get; set; } = null!;
        public virtual DbSet<IssueTypesCode> IssueTypesCodes { get; set; } = null!;
        ...
        public virtual DbSet<MemberProductView> MemberProductViews { get; set; } = null!;
        public virtual DbSet<MembersBoard> MembersBoards { get; set; } = null!;
        public virtual DbSet<News> News { get; set; } = null!;
        public virtual DbSet<NewsCategoryCode> NewsCategoryCodes { get; set; } = null!;
        public virtual DbSet<NewsComment> NewsComments { get; set; } = null!;
        public virtual DbSet<NewsLike> NewsLikes { get; set; } = null!;
        public virtual DbSet<NewsView> NewsViews { get; set; } = null!;
        public virtual DbSet<Newsletter> Newsletters { get; set; } = null!;
        public virtual DbSet<NewsletterLog> NewsletterLogs { get; set; } = null!;
        public virtual DbSet<Order> Orders { get; set; } = null!;
        public virtual DbSet<OrderItem> OrderItems { get; set; } = null!;
        public virtual DbSet<OrderItemReturn> OrderItemReturns { get; set; } = null!;
        public virtual DbSet<OrderItemsCoupon> OrderItemsCoupons { get; set; } = null!;
        public virtual DbSet<OrderStatusCode> OrderStatusCodes { get; set; } = null!;
        public virtual DbSet<PaymentStatusCode> PaymentStatusCodes { get; set; } = null!;
        public virtual DbSet<Post> Posts { get; set; } = null!;
        public virtual DbSet<PostComment> PostComments { get; set; } = null!;
        public virtual DbSet<PostCommentReport> PostCommentReports { get; set; } = null!;
        public virtual DbSet<PostCommentUpDownVote> PostCommentUpDownVotes { get; set; } = null!;
        public virtual DbSet<PostEditLog> PostEditLogs { get; set; } = null!;
        public virtual DbSet<PostReport> PostReports { get; set; } = null!;
        public virtual DbSet<PostUpDownVote> PostUpDownVotes { get; set; } = null!;
        public virtual DbSet<Product> Products { get; set; } = null!;
        public virtual DbSet<ProductImage> ProductImages { get; set; } = null!;
        public virtual DbSet<ProductStatusCode> ProductStatusCodes { get; set; } = null!;
        public virtual DbSet<Reply> Replies { get; set; } = null!;
        public virtual DbSet<Schema> Schemas { get; set; } = null!;
        public virtual DbSet<Server> Servers { get; set; } = null!;
        public virtual DbSet<Set> Sets { get; set; } = null!;
        public virtual DbSet<ShipmemtMethod> ShipmemtMethods { get; set; } = null!;
        public virtual DbSet<ShipmentStatusesCode> ShipmentStatusesCodes { get; set; } = null!;
        public virtual DbSet<StandardProduct> StandardProducts { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BackendMember>(entity =>
            {
                ...
                entity.HasOne(d => d.BackendMembersRole)
                    .WithMany(p => p.BackendMembers)
            ...
            {
                entity.HasOne(d => d.BackendMemberPermission)
                    .WithMany(p => p.BackendMembersRolePermissions)
            ...
            modelBuilder.Entity<Board>(entity =>
            {
                ...
                entity.HasOne(d => d.CreatedBackendMember)
                    .WithMany(p => p.Boards)
            ...
            modelBuilder.Entity<BoardsModerator>(entity =>
            {
                ...
                entity.HasOne(d => d.Board)
                    .WithMany(p => p.BoardsModerators)
                    .HasForeignKey(d => d.BoardId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BoardsMod__Board__1CBC4616");

                entity.HasOne(d => d.ModeratorMember)
                    .WithMany(p => p.BoardsModerators)
            ...
            modelBuilder.Entity<BoardsModeratorsApplication>(entity =>
            {
                ...
                entity.HasOne(d => d.ApprovalStatus)
                    .WithMany(p => p.BoardsModeratorsApplications)
                    .HasForeignKey(d => d.ApprovalStatusId)
                    .HasConstraintName("FK__BoardsMod__Appro__1EA48E88");

                entity.HasOne(d => d.BackendMember)
                    .WithMany(p => p.BoardsModeratorsApplications)
            ...
            modelBuilder.Entity<BucketLog>(entity =>
            {
                ...
                entity.HasOne(d => d.BackendMmember)
                    .WithMany(p => p.BucketLogs)
                ...
                entity.HasOne(d => d.BucketMember)
                    .WithMany(p => p.BucketLogBucketMembers)
                    .HasForeignKey(d => d.BucketMemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BucketLog__Bucke__245D67DE");

                entity.HasOne(d => d.ModeratorMember)
                    .WithMany(p => p.BucketLogModeratorMembers)
                    .HasForeignKey(d => d.ModeratorMemberId)
            ...
            modelBuilder.Entity<Coupon>(entity =>
            {
                ...
                entity.HasOne(d => d.CreatedBackendMember)
                    .WithMany(p => p.CouponCreatedBackendMembers)
                    .HasForeignKey(d => d.CreatedBackendMemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.ModifiedBackendMember)
                    .WithMany(p => p.CouponModifiedBackendMembers)
            ...
            modelBuilder.Entity<Game>(entity =>
            {
                ...
                entity.HasOne(d => d.CreatedBackendMember)
                    .WithMany(p => p.GameCreatedBackendMembers)
                    .HasForeignKey(d => d.CreatedBackendMemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Games__CreatedBa__32AB8735");

                entity.HasOne(d => d.ModifiedBackendMember)
                    .WithMany(p => p.GameModifiedBackendMembers)
                    .HasForeignKey(d => d.ModifiedBackendMemberId)
            ...
            {
                entity.HasOne(d => d.GameClassification)
                    .WithMany(p => p.GameClassificationGames)
            ...
            modelBuilder.Entity<GameComment>(entity =>
            {
                ...
                entity.HasOne(d => d.DeleteBackendMember)
            ...
            {
                entity.HasIndex(e => e.Index, "UQ__Inventor__9A5B6229FC4610D4")
                    .IsUnique();
                ...
                entity.HasOne(d => d.StockInSheet)
                    .WithMany(p => p.InventoryItems)
            ...
            modelBuilder.Entity<MemberProductView>(entity =>
            {
                ...
                entity.HasOne(d => d.Member)
                    .WithMany(p => p.MemberProductViews)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<News>(entity =>
            {
                ...
                entity.HasOne(d => d.BackendMember)
                    .WithMany(p => p.NewsBackendMembers)
                    .HasForeignKey(d => d.BackendMemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__News__BackendMem__3D2915A8");

                entity.HasOne(d => d.DeleteBackendMember)
                    .WithMany(p => p.NewsDeleteBackendMembers)
                    .HasForeignKey(d => d.DeleteBackendMemberId)
            ...
            modelBuilder.Entity<NewsComment>(entity =>
            {
                ...
                entity.HasOne(d => d.DeleteMember)
                    .WithMany(p => p.NewsCommentDeleteMembers)
                    .HasForeignKey(d => d.DeleteMemberId)
                    .HasConstraintName("FK__NewsComme__Delet__40F9A68C");

                entity.HasOne(d => d.Member)
                    .WithMany(p => p.NewsCommentMembers)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<NewsletterLog>(entity =>
            {
                ...
                entity.HasOne(d => d.AddresseeMember)
                    .WithMany(p => p.NewsletterLogs)
            ...
            {
                entity.HasIndex(e => e.Index, "UQ__Orders__9A5B62299A9DCB7B")
                    .IsUnique();
                ...
                entity.HasOne(d => d.ShipmemtMethod)
                    .WithMany(p => p.Orders)
            ...
            {
                entity.HasIndex(e => e.InventoryItemId, "UQ__OrderIte__3BB2AC81819DD448")
                    .IsUnique();

                entity.HasIndex(e => e.Index, "UQ__OrderIte__9A5B62295905CB9C")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.OrderItemId, "UQ__OrderIte__57ED0680FBF10CC1")
                    .IsUnique();

                entity.HasIndex(e => e.Index, "UQ__OrderIte__9A5B6229DB395A7A")
                    .IsUnique();
            ...
            {
                entity.HasOne(d => d.Coupon)
                    .WithMany(p => p.OrderItemsCoupons)
                    .HasForeignKey(d => d.CouponId)
            ...
            modelBuilder.Entity<Post>(entity =>
            {
                ...
                entity.HasOne(d => d.DeleteMember)
                    .WithMany(p => p.PostDeleteMembers)
                    .HasForeignKey(d => d.DeleteMemberId)
                    .HasConstraintName("FK__Posts__DeleteMem__65370702");

                entity.HasOne(d => d.Member)
                    .WithMany(p => p.PostMembers)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<PostComment>(entity =>
            {
                ...
                entity.HasOne(d => d.DeleteMember)
                    .WithMany(p => p.PostCommentDeleteMembers)
                    .HasForeignKey(d => d.DeleteMemberId)
            ...
            modelBuilder.Entity<PostCommentReport>(entity =>
            {
                ...
                entity.HasOne(d => d.Member)
                    .WithMany(p => p.PostCommentReports)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.ReviewerBackenMember)
                    .WithMany(p => p.PostCommentReports)
            ...
            modelBuilder.Entity<PostCommentUpDownVote>(entity =>
            {
                ...
                entity.HasOne(d => d.Member)
                    .WithMany(p => p.PostCommentUpDownVotes)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasIndex(e => e.Index, "UQ__Products__9A5B6229BF6A6C19")
                    .IsUnique();
                ...
                entity.HasOne(d => d.CreatedBackendMember)
                    .WithMany(p => p.ProductCreatedBackendMembers)
                    .HasForeignKey(d => d.CreatedBackendMemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.ModifiedBackendMember)
                    .WithMany(p => p.ProductModifiedBackendMembers)
                    .HasForeignKey(d => d.ModifiedBackendMemberId)
            ...
            {
                entity.HasIndex(e => e.Name, "UQ__Shipmemt__737584F6F62D8AB5")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Index, "UQ__StockInS__9A5B6229FB91117E")
                    .IsUnique();
                ...
                entity.HasOne(d => d.StockInStatus)
                    .WithMany(p => p.StockInSheets)
