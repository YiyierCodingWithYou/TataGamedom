...
namespace TataGamedomWebAPI.Infrastructure
{
	...
	public class SimpleHelper
	{
		...
		public bool MemberIsFollower(int selfId, int memberId)
		{
			var result = _context.MemberFollows.Any(f => f.FollowedMemberId == memberId && f.FollowerMemberId == selfId);
			return result;
		}

		public bool MemberIsFollowed(int selfId, int memberId)
		{
			var result = _context.MemberFollows.Any(f => f.FollowerMemberId == memberId && f.FollowedMemberId == selfId);
			return result;
		}
