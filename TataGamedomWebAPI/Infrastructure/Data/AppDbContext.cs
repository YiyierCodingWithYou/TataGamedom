...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ChatMessage>(entity =>
        {
            ...
            entity.HasIndex(e => e.BackendMemberId, "IX_ChatMessage_BackendMemberId");

            entity.HasIndex(e => e.MemberId, "IX_ChatMessage_MemberId");
        ...
        modelBuilder.Entity<MemberFollow>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.FollowerMemberId, e.FollowedMemberId }, "UcMemberFollow").IsUnique();
