<template>
  ...
  <v-sheet width="300" class="mx-auto">
    <v-form fast-fail @submit.prevent="submitForm">
      <v-text-field v-model="createPassword" label="重設密碼" :rules="createPasswordRules"></v-text-field>

      <v-text-field v-model="confirmPassword" label="確認密碼" :rules="confirmPasswordRules"></v-text-field>
