...
const loadData = async () => {
  try {
    ...
    scheduleDate.value = datas.formatedScheduleDate;
    console.log("DATEEEEEEE", scheduleDate.value);
...
const relativeTime2 = (datetime) => {
  const date = new Date(datetime);
  return (datetime = format(date, "yyyy/MM/dd", { locale: zhTW }));
};
</script>
